    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(lista.size() > 0) {
                ...
                float compra = Float.parseFloat(JOptionPane.showInputDialog("Forneca o preco de compra do produto"));
                float venda = Float.parseFloat(JOptionPane.showInputDialog("Forneca o preco de venda do produto"));
                float margem = Float.parseFloat(JOptionPane.showInputDialog("Forneca o percentual da margem de lucro do produto"));
                float promocao = Float.parseFloat(JOptionPane.showInputDialog("Forneca o percentual de promocao do produto"));
                int estoque = Integer.parseInt(JOptionPane.showInputDialog("Forneca o estoque inicial do produto"));
